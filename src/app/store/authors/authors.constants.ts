export enum AuthorsConstants {
  ...
  REQUEST_SINGLE_AUTHOR = "[Authors] Request Single Author",
  REQUEST_SINGLE_AUTHOR_SUCCESS = "[Authors] Request Single Author Success",
  REQUEST_SINGLE_AUTHOR_FAIL = "[Authors] Request Single Author Fail",
